...
body {
  ...
  background: #0d2a4e; /* fallback solid blue */
  color: #e0f0ff;
  overflow-x: hidden;
  position: relative;
  min-height: 100vh;
...
/* Top Navbar */
.navbar-blur {
  background: rgba(0, 44, 89, 0.85); /* darker blue with opacity */
  ...
  <div class="row g-4 mb-4">
    ...
    <a href ="/my_subjects" class="col-md-4">
      <div class="card-glass">
        ...
        <div>
          ...
          <div class="card-value" id="countPending">—</div>
        </div>
      </div>
    </a>
    ...
    <a href="#" class="col-md-4">
      <div class="card-glass">
        ...
        <div>
          <div class="card-title">My Student</div>
...
<script>
  const DB = {
    mySubjects: [{ code: 'CS101', title: 'Intro to CS', units: 3 }],
    pending: [{ code: 'MATH200', title: 'Calculus II', units: 4, applicants: 2 }],
    notifications: 2,
    activity: [
